...
jQuery(document).ready(function($){
	...
	$(".main-nav a").on("click", function(){
		...
		if ( $dest.charAt(0) === "#" ){
			...
			$('body, html').animate({ scrollTop: $destTop }, 800);
			return false;
		}
	});
	...
	$("a.scroll").on("click", function(){
		...
		$('body, html').animate({ scrollTop: $destTop }, 1000);
		return false;
...
jQuery(document).ready(function(){
	...
	var $container = $('.firstSlide-items');
	...
	function createfirstSlide(){
		...
		$('.firstSlide-item').css("width", $itemWidth );
	...
	$(".firstSlide-popup").magnificPopup({
		type: 'ajax',
		gallery: {
			enabled: true,
			arrowMarkup: ''
...
jQuery(document).ready(function($){
	...
	var $objectivesSlider = $('.objectives-items');

	$objectivesSlider.owlCarousel({
 		autoPlay: 6000,
 		items:3,
	    itemsDesktop : [1199,4],
	...
	var $objectivesSliderInstance = $objectivesSlider.data('owlCarousel');

	$('.objectives-nav .nav-left').click(function(e){
		e.preventDefault();
		$objectivesSliderInstance.prev();
	});
	$('.objectives-nav .nav-right').click(function(e){
		e.preventDefault();
		$objectivesSliderInstance.next();
	});
